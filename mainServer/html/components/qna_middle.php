...
<div class="w3-col m9">
  <div class="w3-card w3-margin-left w3-row-padding w3-col m12">
    ...
    <form class="w3-container" method="post" action="../dbConnection/dbConnection_qna.php">
      ...
      <input name="return_location" type="hidden" value="../pages/qna.php" />
      ...
      <button type="button" class="w3-button w3-border form-btn" onclick="location.href = '../pages/qna.php'">돌아가기</button>
