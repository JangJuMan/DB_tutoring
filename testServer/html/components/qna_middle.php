...
<input name="title" class="comment-input" type="text" placeholder="제목을 입력해주세요" val/ue="">


<select name="state_qna" class="w3-select w3-border" name="option">
...
<select name="state_category" class="w3-select w3-border" name="option">
