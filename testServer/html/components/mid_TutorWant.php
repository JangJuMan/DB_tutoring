...
<div class="w3-col m9">
  ...
  <input class="w3-input" type="text"> -->
      ...
      <input class="comment-input form-element" type="text" placeholder="제목을 입력해주세요."> </input>
          ...
          <div class="w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <div class="check-box-container">
                <div>
                  <label class="check-box-label">월 </label> <input name="mon" class="check-box" type="checkbox" checked>
                  <label class="check-box-label">화 </label> <input name="tue" class="check-box" type="checkbox" checked>
                  <label class="check-box-label">수 </label> <input name="wed" class="check-box" type="checkbox" checked>
                  <label class="check-box-label">목 </label> <input name="thr" class="check-box" type="checkbox" checked>
                  <label class="check-box-label">금 </label> <input name="fri" class="check-box" type="checkbox" checked>
                  <label class="check-box-label">토 </label> <input name="sat" class="check-box" type="checkbox" checked>
                  <label class="check-box-label">일 </label> <input name="sun" class="check-box" type="checkbox" checked>
                </div>
                <div class="check-box-container">
                  <label class="check-box-label">튜터링 종류: </label>
                  <select class="dropdown" name="to_find_tutor">
...
<textarea rows="2" cols="35" name="contents">과외 비용을 입력해주세요. /1시간</textarea> -->
      ...
      <input style="margin-top: 0.5em;" type="text" placeholder="과외 시간을 입력해주세요. /1주일." class="form-element"> </input>
      <input type="text" placeholder="과외 비용을 입력해주세요. /1시간." class="form-element"> </input>

      <select class="dropdown form-element" name="location">
        <?php
      ...
      <textarea class="form-element" rows="13" cols="60" name="content"></textarea>
      ...
      <button class="w3-button w3-border form-btn" onclick="location.href='tutoring.php'">돌아가기</button>
    </form>
  </div>
