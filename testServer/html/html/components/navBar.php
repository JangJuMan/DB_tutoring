...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="main.php" class="w3-bar-item w3-button w3-padding-large <?php if($_SESSION['now'] == 'notice'){echo "w3-theme-d4";}else{echo "w3-hide-small w3-hover-white";}?>" title="News">공지글</a>
  <a href="main.php" class="w3-bar-item w3-button w3-padding-large <?php if($_SESSION['now'] == 'qna'){echo "w3-theme-d4";}else{echo "w3-hide-small w3-hover-white";}?>" title="Account Settings">Q & A</a>
  <a href="main.php" class="w3-bar-item w3-button w3-padding-large <?php if($_SESSION['now'] == 'tutoring'){echo "w3-theme-d4";}else{echo "w3-hide-small w3-hover-white";}?>" title="Messages">과외정보</a>
