...
// 여기서는 writer id 를 가진 애의정보만 넣어 주겠지
 ...
 for($j=0; $j < $user_cnt; $j++){
   if( $writer_info['id'] == $user_list[$j]['id'])
   $num = $j;
 }
          ...
          <div style="padding:40px;">
            <div class="w3-container w3-padding">
              <div class="w3-container w3-padding">
                ...
                <p><option value=1> 이름: <?php echo $user_list[$num]['name']; ?> </option></p>
                <p><option value=1> <b>성별:</b> <?php echo $user_list[$num]['gender']; ?></option></p>
                <p><option value=2> <b>나이:</b> <?php echo $user_list[$num]['birth_year']; ?></option></p>
                <!-- <p><option value=3> <b>과외경력:</b>  echo $user_list[1]['name']; ?></option></p> -->
                <p><option value=4> <b>학교:</b> <?php echo $user_list[$num]['address']; ?> </option></p>
                <p><option value=5> <b>토플/토익 점수:</b>  </option></p>
                <p><option value=6> <b>e-mail:</b> <?php echo $user_list[$num]['email']; ?> </option></p>
